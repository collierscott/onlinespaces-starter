 ...
 */
final class Version20181229133118 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, category_id INT NOT NULL, seo_meta_data_id INT DEFAULT NULL, facebook_meta_data_id INT DEFAULT NULL, twitter_meta_data_id INT DEFAULT NULL, content LONGTEXT NOT NULL, is_published TINYINT(1) NOT NULL, published_start_at DATETIME DEFAULT NULL, published_end_at DATETIME DEFAULT NULL, cover_image VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, page_title VARCHAR(255) DEFAULT NULL, summary LONGTEXT NOT NULL, slug VARCHAR(100) NOT NULL, language VARCHAR(10) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_BFDD3168989D9B62 (slug), INDEX IDX_BFDD3168F675F31B (author_id), INDEX IDX_BFDD316812469DE2 (category_id), UNIQUE INDEX UNIQ_BFDD31689A4416FC (seo_meta_data_id), UNIQUE INDEX UNIQ_BFDD3168BB185326 (facebook_meta_data_id), UNIQUE INDEX UNIQ_BFDD3168EE30D17B (twitter_meta_data_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE avatar_image (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', url VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(100) DEFAULT NULL, is_published TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_3AF34668727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE menu_items (id INT AUTO_INCREMENT NOT NULL, menu_id INT NOT NULL, parent_id INT DEFAULT NULL, label VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, link_type VARCHAR(255) NOT NULL, is_published TINYINT(1) NOT NULL, display_children TINYINT(1) NOT NULL, sort_order INT NOT NULL, is_home TINYINT(1) NOT NULL, icon VARCHAR(255) DEFAULT NULL, INDEX IDX_70B2CA2ACCD7E912 (menu_id), INDEX IDX_70B2CA2A727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE seo_meta_datas (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, site_name VARCHAR(255) NOT NULL, meta_description VARCHAR(255) DEFAULT NULL, meta_keywords VARCHAR(255) DEFAULT NULL, robots VARCHAR(255) DEFAULT NULL, extra_properties JSON NOT NULL COMMENT \'(DC2Type:json_array)\', extra_names JSON NOT NULL COMMENT \'(DC2Type:json_array)\', extra_http JSON NOT NULL COMMENT \'(DC2Type:json_array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, avatar_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, is_enabled TINYINT(1) NOT NULL, is_confirmed TINYINT(1) NOT NULL, is_deleted TINYINT(1) NOT NULL, agreed_terms_at DATETIME NOT NULL, confirmation_token VARCHAR(80) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_1483A5E9F85E0677 (username), UNIQUE INDEX UNIQ_1483A5E986383B10 (avatar_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
