 ...
 */
final class Version20181228184533 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD avatar VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, DROP avatar_id');
    }
}
