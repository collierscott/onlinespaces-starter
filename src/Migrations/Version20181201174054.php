 ...
 */
final class Version20181201174054 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE menu_items (id INT AUTO_INCREMENT NOT NULL, menu_id INT NOT NULL, parent_id INT DEFAULT NULL, alias VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, link_type VARCHAR(255) NOT NULL, is_published TINYINT(1) NOT NULL, sort_order INT NOT NULL, is_home TINYINT(1) NOT NULL, INDEX IDX_70B2CA2ACCD7E912 (menu_id), INDEX IDX_70B2CA2A727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
